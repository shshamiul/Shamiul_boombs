...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf ShamiulBomber && git clone https://github.com/shshamiul/ShamiulBomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd ShamiulBomber && python Shamiul bomber .py")
...
def logo():
    ...
    print("        │ \033[95mGitHub : https://github.com/shshamiul \033[94m                                   │".center(columns+9))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mShamiulBomber\n")
        time.sleep(0.6)
